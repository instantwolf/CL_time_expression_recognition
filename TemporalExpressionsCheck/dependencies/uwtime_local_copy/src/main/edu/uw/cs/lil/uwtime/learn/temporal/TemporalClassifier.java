...
public class TemporalClassifier implements
		IBinaryClassifier<TemporalChunkerOutput> {
	...
	@Override
	public IBinaryClassifierOutput classify(TemporalChunkerOutput dataItem,
