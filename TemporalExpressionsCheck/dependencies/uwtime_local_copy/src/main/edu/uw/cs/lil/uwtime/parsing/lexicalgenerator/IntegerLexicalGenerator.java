 ...
 * @author Kenton Lee
 */
public class IntegerLexicalGenerator implements
	...
	public IntegerLexicalGenerator(
	...
	public Set<LexicalEntry<LogicalExpression>> generateLexicon(
		...
		for (final String token : evidence.getTokens()) {
			try {
				...
				lexicalEntries.add(new LexicalEntry<>(Collections
						.singletonList(token), categoryServices.parse(String
						.format(INTEGER_FORMAT, n)), INTEGER_LEXICAL_ORIGIN));
