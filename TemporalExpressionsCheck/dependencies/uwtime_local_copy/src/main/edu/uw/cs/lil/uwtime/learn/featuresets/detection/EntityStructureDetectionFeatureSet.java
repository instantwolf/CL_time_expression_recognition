...
public class EntityStructureDetectionFeatureSet extends
		TemporalDetectionFeatureSet {
	private static String getStructure(TemporalEntity entity) {
	...
	protected IHashVectorImmutable setMentionFeats(
		...
		feats.set(new KeyArgs(getFeatureTag(), getStructure(dataItem.getChunk()
				.getResult().getEntity())), 1);
		return feats;
	}
}
