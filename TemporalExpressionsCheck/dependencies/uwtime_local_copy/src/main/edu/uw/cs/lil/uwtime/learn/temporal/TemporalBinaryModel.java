...
public class TemporalBinaryModel implements IBinaryModel<TemporalChunkerOutput> {
	...
	public TemporalBinaryModel(
			List<IBinaryFeatureSet<TemporalChunkerOutput>> featureSets) {
	...
	public static class Builder {
		private final List<IBinaryFeatureSet<TemporalChunkerOutput>>	featureSets	= new LinkedList<>();

		public Builder addFeatureSet(
				IBinaryFeatureSet<TemporalChunkerOutput> featureSet) {
