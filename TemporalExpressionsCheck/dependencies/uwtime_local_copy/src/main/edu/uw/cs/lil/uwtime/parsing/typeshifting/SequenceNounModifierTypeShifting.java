...
// N => N/N
public class SequenceNounModifierTypeShifting extends AbstractUnaryRuleForThreading {
	private static final String TYPE_SHIFTING_NAME = "shift_sequence_noun_modifier";
	...
	public SequenceNounModifierTypeShifting(LogicalExpressionCategoryServices categoryServices) {
		this(TYPE_SHIFTING_NAME, categoryServices);
	}

	public SequenceNounModifierTypeShifting(String name, LogicalExpressionCategoryServices categoryServices) {
