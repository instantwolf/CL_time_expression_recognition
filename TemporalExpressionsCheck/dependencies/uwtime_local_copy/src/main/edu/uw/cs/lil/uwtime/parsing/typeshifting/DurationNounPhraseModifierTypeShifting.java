...
// NP => N/N
public class DurationNounPhraseModifierTypeShifting extends AbstractUnaryRuleForThreading {
	private static final String TYPE_SHIFTING_NAME = "shift_duration_noun_phrase_modifier";
	...
	public DurationNounPhraseModifierTypeShifting(LogicalExpressionCategoryServices categoryServices) {
		this(TYPE_SHIFTING_NAME, categoryServices);
	}

	public DurationNounPhraseModifierTypeShifting(String name, LogicalExpressionCategoryServices categoryServices) {
